...
export default function UpdateModal({
  ...
  fetchAmbulanceHandler?: (item?: any) => void;
}) {
  useEffect(() => {
    if (ambulanceDetails) {
      setFormValue({
        title: ambulanceDetails?.title || "",
        description: ambulanceDetails?.description || "",
        location: ambulanceDetails?.location || "",
        contactNumber: ambulanceDetails?.contactNumber || "",
  ...
  const updateAmbulanceHandler = async () => {
    try {
      ...
      AuthAmbulanceServices.updateAmbulances(payload, (item) => {
    ...
    >
      ...
      >
        ...
        <MTButton
          ...
          onClick={updateAmbulanceHandler}
          size="sm"
        >
          <span>Confirm</span>
        </MTButton>
